              ...
              <table>
                ...
                <tbody>
                  {pendingReminders.map(reminder => {
                    ...
                    return (
                      <tr key={reminder.id} style={overdue ? { backgroundColor: '#fee2e2' } : {}}>
                        <td>
                        ...
                        <td>
                          <div style={{ display: 'flex', gap: '0.5rem', flexDirection: 'column' }}>
                            <button
                              ...
                              onClick={() => handleStatusUpdate(reminder.id, 'acknowledged')}
                              disabled={updatingStatus === reminder.id}
                              style={{ backgroundColor: '#eab308' }}
                            >
                              {updatingStatus === reminder.id ? 'Updating...' : 'Acknowledge'}
                            </button>
                            <button
                              className={styles.acceptButton}
                              ...
                              disabled={updatingStatus === reminder.id}
                            >
                              {updatingStatus === reminder.id ? 'Updating...' : 'Complete'}
                            </button>
                          </div>
                        </td>
                      </tr>
