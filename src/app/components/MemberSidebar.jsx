...
const MemberSidebar = () => {
  ...
  const navigation = [
    ...
    { name: 'Submit Standup', href: '/dashboard/submit-standup', icon: '📝' },
    { name: 'Join Team', href: '/dashboard/join-team', icon: '👥' },
    { name: 'My Reminders', href: '/dashboard/reminder', icon: '⏰' },
    { name: 'Invites', href: '/dashboard/invites', icon: '📧' },
  ];
